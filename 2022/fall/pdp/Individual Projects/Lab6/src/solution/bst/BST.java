...
public interface BST<T extends Comparable<T>> {
  ...
  /**
   * Return a list of the elements in this tree in (left to right) pre-order traversal order.
   *
  ...
  /**
   * Return a list of the elements in this tree in (left to right) in-order traversal order.
   *
  ...
  /**
   * Return a list of the elements in this tree in (left to right) post-order traversal order.
   *
